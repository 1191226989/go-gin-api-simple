...
import (
	...
	"go-gin-api-simple/internal/router"
	"go-gin-api-simple/pkg/env"
	"go-gin-api-simple/pkg/logger"
	"go-gin-api-simple/pkg/shutdown"
...
// @license.name MIT
// @license.url https://go-gin-api-simple/blob/master/LICENSE
